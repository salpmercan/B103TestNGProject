...
public class ExcelUtils {
    ...
    private String path;
    //Constructor: Excele path ve sheet name ile sayfaya ulasmak icin
    ...
    //Excell de ki verileri list olarak almamizi saglar
    // Excell deki verileri java test sinifinda kullanmak icin bu methodu kullanacagiz
    ...
    //Excelldeki datalari 2 boyutlu Array seklinde alir
    ...
    //3 parametre aliyor deger,satir ve sutun girildiginde o satir ve sutuna girilen veriyi yazdirir
    ...
    //bu method ustteki method ile birlikte, calisir parametreleri farklidir, overload eder
    ...
    //bu method 2 boyutlu array return eder,  excelldeki tum datalari basliksiz olarak alir
