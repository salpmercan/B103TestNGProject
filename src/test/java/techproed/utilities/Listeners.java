...
public class Listeners implements ITestListener {
    ...
    public void onTestStart(ITestResult result) {
        System.out.println("onTestStart- Her bir @Test once bir kez cagrilir :"+result.getName());
    }

    @Override
    public void onTestSuccess(ITestResult result) {
        System.out.println("onTestSuccess-Sdaece PASS olan testlerden sonra cagrilir :"+result.getName());
    }
